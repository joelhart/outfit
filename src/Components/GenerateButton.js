...
export default function Clothing() {
    ...
    function getCombo() {
                ...
                primary[selection.colorName].forEach(color => {
                    for (let element in dataVar.Pants) {
                        if (dataVar.Pants[element].colorName == color) {
                            ...
                            foundPants = dataVar.Pants[element].colorName;
                        }
                    }
                });
                if (foundPants == null) {foundPants = "No Match Found"}
                ...
                primary[selection.colorName].forEach(color => {
                    for (let element in dataVar.Shoes) {
                        if (dataVar.Shoes[element].colorName == color) {
                            ...
                            foundShoes = dataVar.Shoes[element].colorName;
                        }
                    }
                });
                if (foundShoes == null) {foundShoes = "No Match Found"}
        ...
        //No Shirt named that
        if (selection == null) {
            alert("Sorry, no shirt named that");
        }
    }
